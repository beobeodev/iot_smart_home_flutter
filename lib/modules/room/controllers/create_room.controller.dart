...
class CreateRoomController extends GetxController {
  ...
  CreateRoomController(
      {required this.addRoomToRaspUseCase, required this.rootController});
  ...
  Future<void> addRoom() async {
    ...
    final RequestState<RoomEntity> roomState =
        await addRoomToRaspUseCase.execute(params: roomData);
    if (roomState is RequestFailed) {
      log(roomState.error.toString());
    } else if (roomState is RequestSuccess) {
      rootController.addRoomToRasp(roomState.data!);
    }
  }
}
